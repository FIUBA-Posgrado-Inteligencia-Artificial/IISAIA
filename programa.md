...
El material se organiza en seis unidades temáticas que no se corresponden una a una con las clases: la Unidad 4 se extiende a lo largo de dos encuentros, en cuyo segundo tramo cada estudiante expone la idea de su proyecto integrador y recibe devolución sobre alcance y viabilidad; la última clase se destina íntegramente a la exposición final de los proyectos.
