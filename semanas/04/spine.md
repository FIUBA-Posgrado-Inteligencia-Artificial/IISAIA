...
- **Cómo se paga una sesión** (4 clicks): primero el mecanismo de facturación (precio por 1M de tokens de entrada y de salida, con la entrada como grueso), después tres filas de cuenta comparada: un mensaje suelto ($0,03) → 20 vueltas con 500k en la ventana sin cache ($20) → las mismas 20 vueltas manteniendo el cache ($3,15: una escritura a 1,25× y 19 lecturas a 0,1×) → cierre: el cache vale mientras el principio del contexto no cambie, así que lo estable va primero.
