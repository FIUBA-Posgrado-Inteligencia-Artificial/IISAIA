...
- **Cómo se paga una sesión** (4 clicks): primero el mecanismo de facturación (precio por 1M de tokens de entrada y de salida, con la entrada como grueso), después tres filas de cuenta comparada: un mensaje suelto ($0,15) → 20 vueltas con 500k en la ventana sin cache ($100) → las mismas 20 vueltas manteniendo el cache ($8,63: una escritura a $12,50/1M y 19 lecturas a $0,25/1M). Precios reales de Claude Fable 5.1 ($10 entrada / $50 salida por 1M), verificados contra platform.claude.com/docs/en/about-claude/pricing el 2026-09-15 → cierre: el cache vale mientras el principio del contexto no cambie, así que lo estable va primero.
