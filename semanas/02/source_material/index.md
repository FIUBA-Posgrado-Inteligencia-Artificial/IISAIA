# Semana 2 — Arquitectura Frontend
...
| 5 | [05-single-file-platform.md](05-single-file-platform.md) | Empaque: single-file contra multi-archivo, npm y los límites de cada uno | Anatomía (~9 min) |
...
| 7 | [07-actividad-practica.md](07-actividad-practica.md) | Actividad individual: bad UI con el ciclo Architect → Prompt → Review → Test | Briefing (~8 min) |
